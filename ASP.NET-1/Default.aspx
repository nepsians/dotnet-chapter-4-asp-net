<%@ Page Language="C#" Inherits="ASP.NET1.Default" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <table class="form-table">
                <tr>
                    <td>
                        <label for="RegId">Registration ID:</label></td>
                    <td>
                        <asp:TextBox ID="RegId" runat="server" required="true"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label for="Marks">Marks:</label></td>
                    <td>
                        <asp:TextBox ID="Marks" runat="server" required="true"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        <label for="Address">Address:</label></td>
                    <td>
                        <asp:TextBox ID="Address" runat="server" required="true">
        ...
        <div class="grid-view">
            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" GridLines="Both" DataKeyNames="id" OnPageIndexChanging="GvData_PageIndexChanging" OnRowCancelingEdit="GvData_RowCancelingEdit" OnRowDeleting="GvData_RowDeleting" OnRowEditing="GvData_RowEditing" OnRowUpdating="Gvdata_RowUpdating">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="reg_id" HeaderText="Reg ID" ItemStyle-BorderWidth="1px" ItemStyle-BorderStyle="Solid" HeaderStyle-BorderWidth="1px" HeaderStyle-BorderStyle="Solid" />
                    ...
                    <asp:BoundField DataField="marks" HeaderText="Marks" ItemStyle-BorderWidth="1px" ItemStyle-BorderStyle="Solid" HeaderStyle-BorderWidth="1px" HeaderStyle-BorderStyle="Solid" />
                    <asp:BoundField DataField="address" HeaderText="Address" ItemStyle-BorderWidth="1px" ItemStyle-BorderStyle="Solid" HeaderStyle-BorderWidth="1px" HeaderStyle-BorderStyle="Solid" />
